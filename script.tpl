...
sudo git clone https://github.com/amar-m-cloud/AWS-Wordpress.git /home/ec2-user/AWS-Wordpress
sudo docker-compose -f /home/ec2-user/AWS-Wordpress/docker-compose.yaml up --build -d
